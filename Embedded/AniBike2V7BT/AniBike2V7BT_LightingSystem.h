...
#define MUX_DISABLE			{MUX_CONTROL_PORT.OUTSET = MUX_ENABLE_PIN; }//{MUX_CONTROL_PORT&=MUX_ENABLE_PIN_N;}
#define MUX_IS_DISABLED		(!(PORTA_OUT & MUX_ENABLE_PIN))
#define MUX_ENABLE			{MUX_CONTROL_PORT.OUTCLR = MUX_ENABLE_PIN; }//{MUX_CONTROL_PORT|=MUX_ENABLE_PIN;}

package anibike.widget;

import java.util.LinkedList;

import anibike.loader.R;
...
public class ActionBar extends RelativeLayout implements OnClickListener
{
	 ...
	 * 
	 * This is meant to be used instead of the setHomeAction and does not draw a divider to the left of the provided logo.
	 * 
	 * @param resId
	...
	/*
	 * public static abstract class SearchAction extends AbstractAction { public SearchAction() { super(R.drawable.actionbar_search); } }
	 */
}
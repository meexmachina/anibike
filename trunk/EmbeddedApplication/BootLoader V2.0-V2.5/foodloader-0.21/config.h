...
//	#define BOOT_SECTION_START 0x7000 	//32K-4K=32768-4096=28672 for 2048 word bootloader
    ...
    /* see datasheet! Signature Bytes of the device */
    #define _SIG_BYTE_1 0x1e
    #define _SIG_BYTE_2 0x95
    #define _SIG_BYTE_3 0x0d

    /* see avrdude configuration */
    #define _AVR910_DEVCODE 0x3c
...
#define BOOTLOADER_PINNUM PINE2
#endif
